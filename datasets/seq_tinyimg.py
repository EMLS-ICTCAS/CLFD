...
class SequentialTinyImagenet(ContinualDataset):
    ...
    def get_DWT_backbone():
        return DWT_resnet18(SequentialTinyImagenet.N_CLASSES_PER_TASK
                        * SequentialTinyImagenet.N_TASKS)
    ...
    def get_DWT_transform():
        test_transform = transforms.Compose(
            [transforms.ToTensor(), transforms.Normalize(SequentialTinyImagenet.MEAN, SequentialTinyImagenet.STD)])
