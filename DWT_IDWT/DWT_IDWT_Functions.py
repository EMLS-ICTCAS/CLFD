...
class DWTFunction_2D_hh(Function):
    @staticmethod
    def forward(ctx, input, matrix_Low_0, matrix_Low_1, matrix_High_0, matrix_High_1):
        ctx.save_for_backward(matrix_Low_0, matrix_Low_1, matrix_High_0, matrix_High_1)
        H = torch.matmul(matrix_High_0, input)
...
class IDWTFunction_2D_ll(Function):
    @staticmethod
    def forward(ctx, input_LL, matrix_Low_0, matrix_Low_1, matrix_High_0, matrix_High_1):
        ctx.save_for_backward(matrix_Low_0, matrix_Low_1, matrix_High_0, matrix_High_1)
...
class IDWTFunction_2D_hh(Function):
    @staticmethod
    def forward(ctx, input_HH, matrix_Low_0, matrix_Low_1, matrix_High_0, matrix_High_1):
        ctx.save_for_backward(matrix_Low_0, matrix_Low_1, matrix_High_0, matrix_High_1)
    ...
    def backward(ctx, grad_output):
        ...
        grad_H = torch.matmul(matrix_High_0, grad_output)
        grad_HH = torch.matmul(grad_H, matrix_High_1)
        return grad_HH, None, None, None, None

class IDWTFunction_2D_hh_ll(Function):
    @staticmethod
    def forward(ctx, input_LL, input_HH, matrix_Low_0, matrix_Low_1, matrix_High_0, matrix_High_1):
        ctx.save_for_backward(matrix_Low_0, matrix_Low_1, matrix_High_0, matrix_High_1)
        H = torch.matmul(input_HH, matrix_High_1.t())
        L = torch.matmul(input_LL, matrix_Low_1.t())
        output = torch.add(torch.matmul(matrix_High_0.t(), H), torch.matmul(matrix_Low_0.t(), L))
        return output
    @staticmethod
    def backward(ctx, grad_output):
        matrix_Low_0, matrix_Low_1, matrix_High_0, matrix_High_1 = ctx.saved_variables
        ...
        grad_HH = torch.matmul(grad_H, matrix_High_1)
        grad_LL = torch.matmul(grad_L, matrix_Low_1)
        return grad_LL, grad_HH, None, None, None, None
